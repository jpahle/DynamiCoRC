...
This is the basis for the Quasi-Steady-State and Equilibrium assumption respecitvely.
...
```
Both of these "true" reactions would be modeled with the same Michaelis-Menten-Kinetics so let's see how that holds up:
