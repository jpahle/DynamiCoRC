...
loadSBML("https://raw.githubusercontent.com/jpahle/DynamicPublicationMediaManuscript/main/models/BIOMD0000000010_url.xml")
...
We want to find the parameters of our model that describe the data best. We call this *Parameter Estimation*. We have 22 parameters in our model, so finding the right combination of parameters by chance and just trying out is nearly impossible. Even only using a limited subset of these parameters (as we will do) will not work that way. We will use *algorythms* for that.
...
## 1. Load a model
As stated above, to make a parameter estimation, you have to have a model to work on. If you want to know how to build you own model, you can [klick here](https://jpahle.github.io/CoRC/articles/model_building.html).
