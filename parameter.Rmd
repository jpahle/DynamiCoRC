...
You can have a nicely readable version of the result by using the `str()` function.
For space-reasons we will only take a look at the fitted values, but feel free to take a look at anything you find interesting. 
