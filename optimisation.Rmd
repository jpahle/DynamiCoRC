...
If we want to optimise something, we either want to *minimize* or *maximize* a specific task value.
...
We can the behavior of the species in the plot below. The component we are interested in is Sucrose (Suc).
