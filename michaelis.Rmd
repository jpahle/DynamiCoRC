...
If you have a substrate $S$ and product $P$ and the reaction is catalysed by enzyme $E$, you *can* use Michaelis-Menten-Kinetics to describe this process. The rate of formation  of the product ($v$) is  given by 
...
# Derivation
Michaelis-Menten kinetics follow the assumption that enzyme-catalyzed reaction follow a two step process
$$ 
S + E \rightleftharpoons SE \rightarrow E + P
$$
where the substrate and the enzyme reversibly form a complex $SE$ (with parameters $k_f$ and $k_r$ for forward and reverse reactions) which then catalyzes the formation of the product and the release of the enzyme (with reaction parameter $k_{cat}$).
...
There are two ways of deriving the Michaelis-Menten Kinetics from here. The *Quasi-Steady-State Assumption* and the *Equilibirum approximation*. You have to keep in mind, that both of these have underlying assumptions that need not necessarily be true for your model.  
