...
We will now take a look at another model. This model is about oscillaitons in alcium signalling [(Kummer, 2000)](https://www.ebi.ac.uk/biomodels-main/Biomd0000000329). This model has three species: **G-alpha**, **activePLC** and **Calcium**. All three of these species can oscillate, so we can visualize this in a 3D-plot. 
